...
# simple_kedro_pipeline documentation build
...
from simple_kedro_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "simple_kedro_pipeline"
author = "Kedro"
...
htmlhelp_basename = "simple_kedro_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "simple_kedro_pipeline.tex",
        "simple_kedro_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "simple_kedro_pipeline",
        "Project simple_kedro_pipeline codebase.",
        "Data-Science",
    )
]
